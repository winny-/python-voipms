...
from ..helpers import parameter, validate_maxlength
import validators
...
class DidsSend(BaseApi):
    ...
    @parameter('did', int, 'DID Numbers which is sending the message (Example: 5551234567)', required=True)
    @parameter('dst', int, 'Destination Number (Example: 5551234568)', required=True)
    @parameter('message', str, 'Message to be sent (Example: "hello John Smith" max chars: 160', required=True, validator=validate_maxlength(160))
